...
\begin{wrapfigure}{l}{0.1\textwidth}
	\vspace*{-2em}
		\includegraphics[width=0.15\textwidth]{pic2.jpeg}
\end{wrapfigure}
...
\EducationEntry{Master in Physics ({\href{http://www.exactas.unlp.edu.ar/licenciatura_en_fisica}{FCE})} :}{2013-2019}{Exact Sciences Faculty (FCE), \\ National University of La Plata(UNLP), La Plata, Argentina.}{
\begin{itemize}
\item{Currently in course, date of graduation: May 2019}
\item{Grade Point Average: 9.21 \\ {\href{https://drive.google.com/drive/folders/1je8C0gsbGixCF5rJo3fzQaqo1cs2mjX7?usp=sharing}{Link}} to official Academic Transcript (in spanish).}
\item{Master Thesis: Singularities in quantum field theory.}
\end{itemize}}
\sepspace

\EducationEntry{Scientific Programming Workshop ({\href{https://wtpc.github.io/}{WTPC}}):
}{2018}{National University of Quilmes, Quilmes, Argentina.}{\\
80 hours, face-to-face course.
Featured Topics:
...
\EducationEntry{Machine Learning, Data Science and Deep Learning with Python: \\ ({\href{https://www.udemy.com/data-science-and-machine-learning-with-python-hands-on/}{Udemy Course}}):
}{}{}{
12 hours, virtual course.
Featured Topics:
\begin{itemize}
...
\EducationEntry{Stimulus to scientific vocations ({\href{http://evc.cin.edu.ar/}{EVC}}):}
{2018-2019}
{Balseiro Institute, Bariloche atomic center, Bariloche, Argentina.}
...
\WorkEntry{ Paid Student Teaching Assistant ({\href{https://www.ing.unlp.edu.ar/}{FI}}) :}{}{}{Engineering Faculty (FI), National University of La Plata (UNLP), La Plata, Argentina.}{


Teaching assistant in {\href{https://www.ing.unlp.edu.ar/catedras/F0304/}{Mathematics C}}, second year Engineering subject .
...
\NewPart{Works Presented at Congresses}{}

\sepspace

\WorkEntry{
103° National Physics Reunion of the Argentinian Physics Association:}{}{2018}{}{

Congress from 17/9 to 21/9. In Buenos Aires City, Argentina.

Presented poster 'Spectral Properties of a Singular Operator'.
}
